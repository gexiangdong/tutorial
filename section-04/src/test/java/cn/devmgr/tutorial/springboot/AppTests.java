...
import cn.devmgr.tutorial.springboot.controller.TvSeriesController;
...
public class AppTests {
    ...
    public void testAddSeries() throws Exception{
        ...
        String jsonData = "{\"name\":\"疑犯追踪\",\"episodeCount\":5,\"originalRelease\":\"2011-09-22\",\"tvCharacters\":[{\"name\":\"芬奇\"}]}";
